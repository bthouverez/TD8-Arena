...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/test_game
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/test_game
  DEFINES   += -DDEBUG
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/test_game
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/test_game
  DEFINES   += 
  INCLUDES  += -I. -Isrc -Isrc/gkit -Iinclude -I/usr/include/opencv -I/usr/include/opencv2
...
$(OBJDIR)/gldisplay.o: src/gldisplay.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/test_game.o: test/test_game.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
