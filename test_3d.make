...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/test_3d
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/test_3d
  DEFINES   += -DDEBUG
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/test_3d
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/test_3d
  DEFINES   += 
  INCLUDES  += -I. -Isrc -Isrc/gkit -Iinclude -I/usr/include/opencv -I/usr/include/opencv2
...
$(OBJDIR)/renderable_asteroid.o: src/renderable_asteroid.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/test_3d.o: test/test_3d.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
