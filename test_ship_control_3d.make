...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/test_ship_control_3d
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/test_ship_control_3d
  DEFINES   += -DDEBUG
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/test_ship_control_3d
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/test_ship_control_3d
  DEFINES   += 
  INCLUDES  += -I. -Isrc -Isrc/gkit -Iinclude -I/usr/include/opencv -I/usr/include/opencv2
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking test_ship_control_3d
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning test_ship_control_3d
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/renderable_entity.o: src/renderable_entity.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/test_ship_control_3d.o: test/test_ship_control_3d.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
