...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/test_calib
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/test_calib
  DEFINES   += -DDEBUG
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/test_calib
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/test_calib
  DEFINES   += 
  INCLUDES  += -I. -Isrc -Isrc/gkit -Iinclude -I/usr/include/opencv -I/usr/include/opencv2
...
$(OBJDIR)/gldisplay.o: src/gldisplay.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/test_calib.o: test/test_calib.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
