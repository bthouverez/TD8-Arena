...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/test_chessboard
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/test_chessboard
  DEFINES   += -DDEBUG
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/test_chessboard
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/test_chessboard
  DEFINES   += 
  INCLUDES  += -I. -Isrc -Isrc/gkit -Iinclude -I/usr/include/opencv -I/usr/include/opencv2
...
$(OBJDIR)/renderable_asteroid.o: src/renderable_asteroid.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/test_chessboard.o: test/test_chessboard.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
